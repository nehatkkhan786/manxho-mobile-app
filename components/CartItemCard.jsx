...
const CartItemCard = ({item}) => {
  ...
  return (
    <View style={{ paddingHorizontal:12, marginHorizontal:10, borderRadius:10, backgroundColor:'white', shadowOpacity: 0.3, borderColor:'black', marginBottom:15, paddingBottom:10, }}> 
